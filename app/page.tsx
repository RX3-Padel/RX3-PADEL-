    ...
    <main className="min-h-screen bg-[#0B1F3A] text-white">
      <header className="max-w-6xl mx-auto px-6 py-6">
        <div className="flex items-center justify-between gap-6">
          <a href="#" className="relative h-12 w-40 md:h-14 md:w-52">
            <Image
              src="/rx3-og.jpg"
              alt="PX3 Padel Club"
              fill
          ...
          <nav className="flex justify-end gap-8 text-sm text-white/80">
      ...
      <section id="club" className="bg-[#F4F3EF] text-[#0A2F1F] py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="relative mx-auto mb-8 h-12 w-44 md:h-14 md:w-56">
            <Image
              src="/rx3-og.jpg"
              alt="PX3 Padel Club"
              fill
      ...
      <section id="locations" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div>
            <h3 className="text-xl font-semibold">Bury St Edmunds</h3>
            <p className="text-[#F4F3EF]/80">Opening Soon</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold">Winchester</h3>
            <p className="text-[#F4F3EF]/80">Planned</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold">Horsham</h3>
            <p className="text-[#F4F3EF]/80">Planned</p>
          </div>
          <div className="md:col-span-3">
            <h3 className="text-xl font-semibold mt-6">Reigate</h3>
            <p className="text-[#F4F3EF]/80">Planned</p>
          </div>
        </div>
      </section>
